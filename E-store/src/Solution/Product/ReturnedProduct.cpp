...
ReturnedProduct::ReturnedProduct():reason("")
{
...
ReturnedProduct::ReturnedProduct(const ReturnedProduct &prodRet) : NonFoodProduct(prodRet),reason(prodRet.reason)
{
